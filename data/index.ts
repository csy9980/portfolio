...
export const projects = [
  ...
  {
    id: 4,
    title: "인천국제공항 디지털 아카이브",
    des: "인천국제공항 디지털 아카이브 사용자 페이지",
    img: "/airport.png",
    iconLists: ["/html.svg", "/css.svg", "/js.svg", "/boot.svg", "/jquery.svg"],
    link: "http://proj_mcms.tigensoft.co.kr:9090/_icAir/_front/",
  },
  {
    id: 5,
    title: "사내 서비스 및 이벤트 홈페이지",
    des: "휴양소 홈페이지, 티고 홈페이지 등 사내 서비스 관련 홈페이지 퍼블리싱",
    img: "/tigen.png",
    iconLists: ["/html.svg", "/css.svg", "/js.svg", "/boot.svg", "/jquery.svg"],
  ...
  {
    id: 6,
    title: "한국산업기술 진흥원 콘텐츠 관리시스템",
    des: "한국산업기술 진흥원 미디어 콘텐츠 관리시스템 사용자 페이지",
    img: "/kiat.png",
    iconLists: ["/html.svg", "/css.svg", "/js.svg", "/boot.svg", "/jquery.svg"],
    link: "http://proj_mcms.tigensoft.co.kr:9090/_kiat/_front/",
  },
  {
    id: 7,
    title: "서울시의회 교육시스템",
    des: "서울특별시의회 교육시스템 사용자 페이지",
    img: "/seoul.png",
    iconLists: ["/html.svg", "/css.svg", "/js.svg", "/boot.svg", "/jquery.svg"],
    link: "http://pub_lms-lite.tigensoft.co.kr:9090/_smc/_front/",
  },  
  {
    id: 8,
    title: "티홈 App",
    des: "Thome 어플리케이션 사용자화면",
    img: "/thome.png",
    iconLists: ["/html.svg", "/css.svg", "/js.svg", "/boot.svg", "/jquery.svg"],
    link: "http://pub_tgo.tigensoft.co.kr:9090/service/_userApp/html/contents/member/login.jsp",
  }, 
  {
    id: 9,
    title: "공군 UMS",
    des: "공군 UMS 고도화 작업 퍼블리싱",
    img: "/airforce.png",
    iconLists: ["/html.svg", "/css.svg", "/js.svg", "/boot.svg", "/jquery.svg"],
    link: "http://pub_push.tigensoft.co.kr:9090/_airforce/app/html/contents/member/login.jsp",
  }, 
];
